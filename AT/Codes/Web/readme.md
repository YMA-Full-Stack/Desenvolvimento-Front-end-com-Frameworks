...
O projeto foi desenvolvido com foco em organização de componentes, navegação entre páginas, consumo de API pública, autenticação, banco de dados, responsividade e testes automatizados.
...
Além da aplicação web, o projeto também conta com uma versão mobile complementar desenvolvida em **React Native/Expo** com **NativeBase**.

A versão mobile está disponível no Expo Snack:
...
Esta é a versão web principal do projeto MindCare. Ela foi desenvolvida em React e TypeScript, com foco em responsividade, autenticação, consumo de dados externos, persistência de informações e testes automatizados.
